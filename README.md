...
| **N18 BUILT:** N17 skeleton + two new guarded families (TabICLv2 full-context, TabM k=32 ensemble) + N-way Nelder-Mead blend search (pairwise scan retained as guardrail floor) + thresholds + PL. | `n18-sota-families.ipynb` | Awaiting execution. |
| **Run order:** Do **not** re-upload N13, N14v3, N14v4, N15v4, N16, or N17 (all already scored/retired). Upload and run **N18** next. | — | N18 is the only open notebook. |
